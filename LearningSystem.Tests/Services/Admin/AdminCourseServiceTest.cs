namespace LearningSystem.Tests.Services.Admin
{
    ...
    public class AdminCourseServiceTest
    {
        ...
        private async Task<LearningSystemDbContext> PrepareCourses()
        {
        ...
        private async Task<LearningSystemDbContext> PrepareUsers()
        {
        ...
        private IAdminCourseService InitializeAdminCourseService(LearningSystemDbContext db)
