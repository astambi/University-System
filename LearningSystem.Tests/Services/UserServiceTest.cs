namespace LearningSystem.Tests.Services
{
    ...
    public class UserServiceTest
    {
        ...
        private async Task<LearningSystemDbContext> PrepareUserCertificates()
        {
            var user = new User { Id = UserIdValid };
        ...
        private async Task<LearningSystemDbContext> PrepareUserExams()
        {
            var user = new User { Id = UserIdValid };
            var userOther = new User { Id = "AnotherUser" };
        ...
        private async Task<LearningSystemDbContext> PrepareUserResources()
        {
            var user = new User { Id = UserIdValid };
            var userOther = new User { Id = "AnotherUser" };
