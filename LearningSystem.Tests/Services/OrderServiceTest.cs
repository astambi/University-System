namespace LearningSystem.Tests.Services
{
    ...
    public class OrderServiceTest
    {
        ...
        private async Task<LearningSystemDbContext> PrepareOrderBasic()
        {
            var db = Tests.InitializeDatabase();
        ...
        private async Task<LearningSystemDbContext> PrepareOrderWithNonExistingCourse()
        {
        ...
        private async Task<LearningSystemDbContext> PrepareOrderWithCourseThatHasAlreadyStarted()
        {
            var currentDateTime = DateTime.UtcNow;
        ...
        private async Task<LearningSystemDbContext> PrepareOrderWithAllFutureCourses()
        {
            var currentDateTime = DateTime.UtcNow;
            var futureDateTime = currentDateTime.AddDays(1);
        ...
        private async Task<LearningSystemDbContext> PrepareUserAndCoursesWithCourseThatHasAlreadyStarted()
        {
            var currentDateTime = DateTime.UtcNow;
            var futureDateTime = currentDateTime.AddDays(1);
            var pastDateTime = currentDateTime.AddDays(-1);
        ...
        private async Task<LearningSystemDbContext> PrepareUserAndFutureCourses()
        {
            var currentDateTime = DateTime.UtcNow;
            var futureDateTime = currentDateTime.AddDays(1);
        ...
        private async Task<LearningSystemDbContext> PrepareUserWithEnrolledFutureCourses()
        {
            var currentDateTime = DateTime.UtcNow;
            var futureDateTime = currentDateTime.AddDays(1);
        ...
        private async Task<LearningSystemDbContext> PrepareUserOrdersWithInvoice()
        {
        ...
        private IOrderService InitializeOrderService(LearningSystemDbContext db)
